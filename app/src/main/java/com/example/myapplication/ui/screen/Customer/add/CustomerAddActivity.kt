        ...
        LazyColumn (
            ...
            item{
                GenericCard(
                    ...
                    onClick = {
                        if(!state.referralId.isNullOrBlank()){
                            navController.currentBackStackEntry
                                ?.savedStateHandle
                                ?.set("initialIds", listOf(state.referralId))
                        }
                        navController.navigate(NavigationRoute.Select(selectSearchText, SelectKey.AllCustomers))
                    }
                )
            }
            item{
