...
fun Screen(modifier : Modifier){
    ...
    Scaffold (
        ...
        topBar = {
            TopAppBar("Screen",
            navigationIcon = {
                BackButton(){val intent = Intent(ctx, AllCustomersSummaryActivity ::class.java)
        ...
        LazyColumn(
            ...
            item{CustomLabel("CF", "RSSMRA80A01A944I", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
            item{CustomLabel("Nome", "Mario", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
            item{CustomLabel("Cognome", "Rossi", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
            item{CustomLabel("Indirizzo", "Piazza Dei Martiri 2", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
            item{CustomLabel("Comune", "Bologna", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
            item{CustomLabel("CAP", "40133", weightTitle = 0.5f, weighDescription = 1.0f)}
            item{Spacer(Modifier.size(8.dp))}
