...
@Composable
fun SelectAddressActivity(
    state : SelectAddressState,
    actions: SelectAddressActions,
    ...
    Scaffold(
                    ...
                    IconButton(
                        onClick = {
                            ...
                            navController.previousBackStackEntry
                                ?.savedStateHandle
                                ?.set("selectedAddressIds", selectedIds)
        ...
        LazyColumn(
            ...
            item {CustomSearchBar(stringResource(R.string.address), onValueChange = {})}
