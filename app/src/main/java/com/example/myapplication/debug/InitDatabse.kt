...
object seedDatabase {
    suspend fun seedMaterials(repository: Repository) {
        val materials : List<Material> = listOf(
            ...
            Material(id = 7, model = "Hub 2 Plus", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Centrali", availability = 10.0f, unitMeasurement = "PZ"),
            Material(id = 8, model = "MotionProtect", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Sensori", availability = 45.0f, unitMeasurement = "PZ"),
            Material(id = 9, model = "DoorProtect", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Contatti", availability = 60.0f, unitMeasurement = "PZ"),
            Material(id = 10, model = "FireProtect", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Fumo", availability = 15.0f, unitMeasurement = "PZ"),
            Material(id = 11, model = "StreetSiren", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Sirene", availability = 8.0f, unitMeasurement = "PZ"),
            Material(id = 12, model = "Cavo Allarme 4x0.22", brand = "FROR", type = JobType.valueOf("ALA"), category = "Cavi", availability = 1000.0f, unitMeasurement = "M"),
            Material(id = 13, model = "Tastiera LCD", brand = "Bentel", type = JobType.valueOf("ALA"), category = "Interfacce", availability = 5.0f, unitMeasurement = "PZ"),
            Material(id = 14, model = "Sensore Doppia Tech", brand = "Optex", type = JobType.valueOf("ALA"), category = "Esterno", availability = 12.0f, unitMeasurement = "PZ"),
            Material(id = 15, model = "Batteria 12V 7Ah", brand = "FIAMM", type = JobType.valueOf("ALA"), category = "Ricambi", availability = 20.0f, unitMeasurement = "PZ"),
            Material(id = 16, model = "Combinatore GSM", brand = "Bentel", type = JobType.valueOf("ALA"), category = "Moduli", availability = 13.0f, unitMeasurement = "PZ"),
            Material(id = 17, model = "Interruttore 16A", brand = "Bticino", type = JobType.valueOf("ELE"), category = "Frutti", availability = 200.0f, unitMeasurement = "PZ"),
            Material(id = 18, model = "Presa Schuko", brand = "Vimar", type = JobType.valueOf("ELE"), category = "Frutti", availability = 150.0f, unitMeasurement = "PZ"),
            Material(id = 19, model = "Magnetotermico 25A", brand = "ABB", type = JobType.valueOf("ELE"), category = "Quadri", availability = 32.0f, unitMeasurement = "PZ"),
            Material(id = 20, model = "Differenziale 0.03A", brand = "Gewiss", type = JobType.valueOf("ELE"), category = "Quadri", availability = 25.0f, unitMeasurement = "PZ"),
            Material(id = 21, model = "Cavo FS17 2.5mm", brand = "Prysmian", type = JobType.valueOf("ELE"), category = "Cavi", availability = 3000.0f, unitMeasurement = "M"),
            Material(id = 22, model = "Corrugato 25mm", brand = "Arnocanali", type = JobType.valueOf("ELE"), category = "Tubi", availability = 500.0f, unitMeasurement = "M"),
            Material(id = 23, model = "Scatola 503", brand = "Bticino", type = JobType.valueOf("ELE"), category = "Supporti", availability = 400.0f, unitMeasurement = "PZ"),
            Material(id = 24, model = "Placca 3 Posti", brand = "Vimar", type = JobType.valueOf("ELE"), category = "Finiture", availability = 300.0f, unitMeasurement = "PZ"),
            Material(id = 25, model = "Relè Passo-Passo", brand = "Finder", type = JobType.valueOf("ELE"), category = "Automazione", availability = 50.0f, unitMeasurement = "PZ"),
            Material(id = 26, model = "Trasformatore 24V", brand = "MeanWell", type = JobType.valueOf("ELE"), category = "Alimentatori", availability = 15.0f, unitMeasurement = "PZ"),
            Material(id = 27, model = "Perfera 12000", brand = "Daikin", type = JobType.valueOf("CDZ"), category = "Split", availability = 12.0f, unitMeasurement = "PZ"),
            Material(id = 28, model = "Kirigamine Zen", brand = "Mitsubishi", type = JobType.valueOf("CDZ"), category = "Split", availability = 8.0f, unitMeasurement = "PZ"),
            Material(id = 29, model = "Unità Esterna Mono", brand = "Samsung", type = JobType.valueOf("CDZ"), category = "Motori", availability = 5.0f, unitMeasurement = "PZ"),
            Material(id = 30, model = "Trial Split Esterna", brand = "Daikin", type = JobType.valueOf("CDZ"), category = "Motori", availability = 3.0f, unitMeasurement = "PZ"),
            Material(id = 31, model = "Canalina 60x45", brand = "Vortice", type = JobType.valueOf("CDZ"), category = "Accessori", availability = 100.0f, unitMeasurement = "M"),
            Material(id = 32, model = "Tubo Rame 1/4", brand = "Zeta", type = JobType.valueOf("CDZ"), category = "Tubi", availability = 250.0f, unitMeasurement = "M"),
            Material(id = 33, model = "Tubo Rame 3/8", brand = "Zeta", type = JobType.valueOf("CDZ"), category = "Tubi", availability = 200.0f, unitMeasurement = "M"),
            Material(id = 34, model = "Pompa Scarico Condensa", brand = "Sauermann", type = JobType.valueOf("CDZ"), category = "Accessori", availability = 20.0f, unitMeasurement = "PZ"),
            Material(id = 35, model = "Gas R32 5kg", brand = "Refrigerant", type = JobType.valueOf("CDZ"), category = "Gas", availability = 10.0f, unitMeasurement = "KG"),
            Material(id = 36, model = "Staffe Motore", brand = "Tecnosystemi", type = JobType.valueOf("CDZ"), category = "Supporti", availability = 40.0f, unitMeasurement = "PZ"),
            Material(id = 37, model = "Dual Split Esterna", brand = "LG", type = JobType.valueOf("CDZ"), category = "Motori", availability = 4.0f, unitMeasurement = "PZ"),
            Material(id = 38, model = "Sensore Allagamento", brand = "Ajax", type = JobType.valueOf("ALA"), category = "Sensori", availability = 10.0f, unitMeasurement = "PZ"),
            Material(id = 39, model = "Sirena Interna", brand = "Bentel", type = JobType.valueOf("ALA"), category = "Sirene", availability = 15.0f, unitMeasurement = "PZ"),
            Material(id = 40, model = "Quadro 24 Moduli", brand = "Gewiss", type = JobType.valueOf("ELE"), category = "Quadri", availability = 10.0f, unitMeasurement = "PZ"),
            Material(id = 41, model = "Lampada Emergenza", brand = "Beghelli", type = JobType.valueOf("ELE"), category = "Illuminazione", availability = 20.0f, unitMeasurement = "PZ"),
            Material(id = 42, model = "Faretto LED 10W", brand = "Philips", type = JobType.valueOf("ELE"), category = "Illuminazione", availability = 50.0f, unitMeasurement = "PZ"),
            Material(id = 43, model = "Termostato Wi-Fi", brand = "Bticino", type = JobType.valueOf("ELE"), category = "Domotica", availability = 15.0f, unitMeasurement = "PZ"),
            Material(id = 44, model = "Attuatore Tapparelle", brand = "Shelly", type = JobType.valueOf("ELE"), category = "Domotica", availability = 40.0f, unitMeasurement = "PZ"),
            Material(id = 45, model = "Pulsante Campanello", brand = "Vimar", type = JobType.valueOf("ELE"), category = "Frutti", availability = 25.0f, unitMeasurement = "PZ"),
            Material(id = 46, model = "Rivelatore Gas", brand = "Beghelli", type = JobType.valueOf("ALA"), category = "Sicurezza", availability = 8.0f, unitMeasurement = "PZ"),
            Material(id = 47, model = "Clima WindFree", brand = "Samsung", type = JobType.valueOf("CDZ"), category = "Split", availability = 6.0f, unitMeasurement = "PZ"),
            Material(id = 48, model = "Barriera Infrarosso", brand = "Optex", type = JobType.valueOf("ALA"), category = "Perimetrale", availability = 4.0f, unitMeasurement = "PZ"),
            Material(id = 49, model = "Alimentatore 12V 5A", brand = "Hearth", type = JobType.valueOf("ALA"), category = "Alimentatori", availability = 12.0f, unitMeasurement = "PZ"),
            Material(id = 50, model = "Cavo Dati Cat6", brand = "Belden", type = JobType.valueOf("ELE"), category = "Cavi", availability = 1500.0f, unitMeasurement = "M"),
            Material(id = 51, model = "Spina Industriale 16A", brand = "Scame", type = JobType.valueOf("ELE"), category = "Connettori", availability = 30.0f, unitMeasurement = "PZ"),
            Material(id = 52, model = "Presa Interbloccata", brand = "Scame", type = JobType.valueOf("ELE"), category = "Connettori", availability = 10.0f, unitMeasurement = "PZ"),
            Material(id = 53, model = "Condizionatore Portatile", brand = "Olimpia", type = JobType.valueOf("CDZ"), category = "Mobile", availability = 3.0f, unitMeasurement = "PZ"),
            Material(id = 54, model = "Telecomando Universale", brand = "Melchioni", type = JobType.valueOf("CDZ"), category = "Ricambi", availability = 50.0f, unitMeasurement = "PZ"),
            Material(id = 55, model = "Filtro Aria Clima", brand = "Daikin", type = JobType.valueOf("CDZ"), category = "Ricambi", availability = 100.0f, unitMeasurement = "PZ"),
            Material(id = 56, model = "Nastro Isolante", brand = "3M", type = JobType.valueOf("ELE"), category = "Consumabili", availability = 500.0f, unitMeasurement = "PZ"),
            Material(id = 58, model = "NM09PXOABB", brand = "Nimaco", type = JobType.valueOf("CDZ"), category = "Split", availability = 1.0f, unitMeasurement = "PZ"),
            Material(id = 59, model = "NM12PXOABB", brand = "Nimaco", type = JobType.valueOf("CDZ"), category = "Split", availability = 1.0f, unitMeasurement = "PZ"),
            Material(id = 61, model = "Plana", brand = "Vimar", type = JobType.valueOf("ELE"), category = "Interruttore", availability = 21.0f, unitMeasurement = "PZ"),
            Material(id = 62, model = "JSMKL568PP", brand = "Daikin", type = JobType.valueOf("CDZ"), category = "Split", availability = 2.0f, unitMeasurement = "PZ"),
            Material(id = 63, model = "JSMKL569OOP", brand = "Daikin", type = JobType.valueOf("CDZ"), category = "Split", availability = 4.0f, unitMeasurement = "PZ")
        )
    ...
    suspend fun seedPayment(repository : Repository){
        val payments = listOf(
            Payment(id = 1, issueDate = LocalDate.of(2023, 1, 20), paymentDate = LocalDate.of(2023, 1, 20)),
            Payment(id = 2, issueDate = LocalDate.of(2023, 2, 15), paymentDate = LocalDate.of(2023, 2, 28)),
            Payment(id = 3, issueDate = LocalDate.of(2023, 3, 10), paymentDate = LocalDate.of(2023, 3, 10)),
            Payment(id = 4, issueDate = LocalDate.of(2023, 5, 25), paymentDate = LocalDate.of(2023, 5, 30)),
            Payment(id = 5, issueDate = LocalDate.of(2024, 6, 15), paymentDate = LocalDate.of(2024, 6, 15)),
            Payment(id = 6, issueDate = LocalDate.of(2023, 8, 1), paymentDate = LocalDate.of(2023, 8, 5)),
            Payment(id = 7, issueDate = LocalDate.of(2023, 10, 12), paymentDate = LocalDate.of(2023, 11, 12)),
            Payment(id = 8, issueDate = LocalDate.of(2023, 12, 20), paymentDate = LocalDate.of(2023, 12, 22)),
            Payment(id = 9, issueDate = LocalDate.of(2024, 1, 15), paymentDate = LocalDate.of(2024, 1, 15)),
            Payment(id = 10, issueDate = LocalDate.of(2024, 1, 30), paymentDate = LocalDate.of(2024, 2, 15)),
            Payment(id = 11, issueDate = LocalDate.of(2024, 2, 10), paymentDate = LocalDate.of(2024, 2, 10)),
            Payment(id = 12, issueDate = LocalDate.of(2024, 2, 28), paymentDate = LocalDate.of(2024, 3, 5)),
            Payment(id = 13, issueDate = LocalDate.of(2024, 3, 15), paymentDate = LocalDate.of(2024, 3, 15)),
            Payment(id = 14, issueDate = LocalDate.of(2024, 3, 20), paymentDate = LocalDate.of(2024, 3, 25)),
            Payment(id = 15, issueDate = LocalDate.of(2024, 3, 28), paymentDate = LocalDate.of(2024, 3, 28)),
            Payment(id = 16, issueDate = LocalDate.of(2024, 4, 1), paymentDate = LocalDate.of(2024, 4, 2)),
            Payment(id = 17, issueDate = LocalDate.of(2024, 4, 5), paymentDate = LocalDate.of(2024, 4, 5)),
            Payment(id = 18, issueDate = LocalDate.of(2026, 2, 10), paymentDate = null),
            Payment(id = 19, issueDate = LocalDate.of(2024, 3, 1), paymentDate = null),
            Payment(id = 20, issueDate = LocalDate.of(2024, 4, 10), paymentDate = null),
            Payment(id = 21, issueDate = LocalDate.of(2023, 1, 1), paymentDate = LocalDate.of(2024, 1, 1)),
            Payment(id = 22, issueDate = LocalDate.of(2024, 5, 15), paymentDate = null),
            ...
            Payment(id = 26, issueDate = LocalDate.of(2026, 2, 12), paymentDate = LocalDate.of(2026, 2, 14)),
            Payment(id = 27, issueDate = LocalDate.of(2026, 12, 30), paymentDate = null),
            Payment(id = 28, issueDate = LocalDate.of(2026, 2, 9), paymentDate = LocalDate.of(2026, 2, 12)),
            Payment(id = 29, issueDate = LocalDate.of(2026, 3, 1), paymentDate = LocalDate.of(2026, 3, 4)),
            Payment(id = 30, issueDate = LocalDate.of(2026, 2, 28), paymentDate = LocalDate.of(2026, 3, 4))
        )
    ...
    suspend fun seedSingleExpense(repository : Repository){
        val expenses = listOf(
            ...
            SingleExpense(id = 21, name = "Parcheggio cantiere Roma", amount = 15f, deadlineDate = LocalDate.of(2023, 1, 20), category = 4, purchaseInvoice = null, payment = 1),
            SingleExpense(id = 41, name = "Rimborso spese cliente X", amount = 30f, deadlineDate = LocalDate.of(2022, 12, 31), category = 10, purchaseInvoice = null, payment = 1),
            ...
            SingleExpense(id = 16, name = "Rifornimento Diesel", amount = 95f, deadlineDate = LocalDate.of(2023, 2, 15), category = 4, purchaseInvoice = 27, payment = 2),
            ...
            SingleExpense(id = 30, name = "Diritti di segreteria", amount = 16f, deadlineDate = LocalDate.of(2023, 3, 10), category = 8, purchaseInvoice = null, payment = 3),
            ...
            SingleExpense(id = 28, name = "Abbonamento parcheggio mensile", amount = 80f, deadlineDate = LocalDate.of(2023, 5, 25), category = 4, purchaseInvoice = null, payment = 4),
            SingleExpense(id = 45, name = "Bollo furgone", amount = 155f, deadlineDate = LocalDate.of(2024, 1, 1), category = 4, purchaseInvoice = null, payment = 4),
            SingleExpense(id = 24, name = "Mancia corriere urgenza", amount = 5f, deadlineDate = LocalDate.of(2024, 1, 10), category = 10, purchaseInvoice = null, payment = 5),
            SingleExpense(id = 5, name = "Materiale promozionale", amount = 300f, deadlineDate = LocalDate.of(2023, 8, 1), category = 10, purchaseInvoice = 21, payment = 6),
            SingleExpense(id = 31, name = "Acquisto manuale tecnico", amount = 45f, deadlineDate = LocalDate.of(2023, 8, 5), category = 10, purchaseInvoice = null, payment = 6),
            SingleExpense(id = 17, name = "Acquisto DPI (Guanti)", amount = 150f, deadlineDate = LocalDate.of(2023, 6, 12), category = 1, purchaseInvoice = 32, payment = 7),
            SingleExpense(id = 18, name = "Manutenzione climatizzatore ufficio", amount = 80f, deadlineDate = LocalDate.of(2023, 11, 20), category = 2, purchaseInvoice = 37, payment = 7),
            SingleExpense(id = 25, name = "Taxi fiera Milano", amount = 45f, deadlineDate = LocalDate.of(2023, 10, 12), category = 10, purchaseInvoice = null, payment = 7),
            SingleExpense(id = 6, name = "Cena aziendale Natale", amount = 450f, deadlineDate = LocalDate.of(2023, 12, 20), category = 10, purchaseInvoice = 26, payment = 8),
            SingleExpense(id = 7, name = "Cambio Gomme Invernali", amount = 600f, deadlineDate = LocalDate.of(2024, 1, 15), category = 7, purchaseInvoice = 31, payment = 9),
            SingleExpense(id = 19, name = "Pubblicità Facebook", amount = 100f, deadlineDate = LocalDate.of(2024, 1, 15), category = 10, purchaseInvoice = 42, payment = 9),
            SingleExpense(id = 32, name = "Sostituzione tergicristalli", amount = 35f, deadlineDate = LocalDate.of(2024, 1, 20), category = 7, purchaseInvoice = null, payment = 9),
            SingleExpense(id = 8, name = "Rifornimento Metano", amount = 40f, deadlineDate = LocalDate.of(2024, 1, 30), category = 4, purchaseInvoice = 36, payment = 10),
            SingleExpense(id = 20, name = "Marche da bollo", amount = 32f, deadlineDate = LocalDate.of(2024, 2, 20), category = 8, purchaseInvoice = 47, payment = 10),
            SingleExpense(id = 29, name = "Pulizia straordinaria vetrate", amount = 200f, deadlineDate = LocalDate.of(2024, 2, 15), category = 6, purchaseInvoice = null, payment = 10),
            SingleExpense(id = 9, name = "Cartucce stampante", amount = 95f, deadlineDate = LocalDate.of(2024, 2, 10), category = 8, purchaseInvoice = 41, payment = 11),
            SingleExpense(id = 10, name = "Kit pronto soccorso", amount = 35f, deadlineDate = LocalDate.of(2024, 2, 28), category = 9, purchaseInvoice = 46, payment = 12),
            SingleExpense(id = 33, name = "Timbro aziendale nuovo", amount = 18f, deadlineDate = LocalDate.of(2024, 2, 28), category = 8, purchaseInvoice = null, payment = 12),
            SingleExpense(id = 11, name = "Viti e tasselli sfusi", amount = 22.5f, deadlineDate = LocalDate.of(2024, 3, 15), category = 1, purchaseInvoice = 2, payment = 13),
            SingleExpense(id = 22, name = "Caffè e acqua ufficio", amount = 25f, deadlineDate = LocalDate.of(2024, 3, 15), category = 8, purchaseInvoice = null, payment = 13),
            SingleExpense(id = 12, name = "Materiale pulizia sede", amount = 18f, deadlineDate = LocalDate.of(2024, 3, 20), category = 6, purchaseInvoice = 7, payment = 14),
            SingleExpense(id = 26, name = "Software open source donation", amount = 10f, deadlineDate = LocalDate.of(2024, 3, 20), category = 10, purchaseInvoice = null, payment = 14),
            SingleExpense(id = 27, name = "Piccola viteria brico", amount = 12.4f, deadlineDate = LocalDate.of(2024, 3, 25), category = 1, purchaseInvoice = null, payment = 14),
            SingleExpense(id = 13, name = "Riparazione serratura", amount = 110f, deadlineDate = LocalDate.of(2024, 3, 28), category = 5, purchaseInvoice = 12, payment = 15),
            SingleExpense(id = 39, name = "Commissioni bancarie", amount = 0.5f, deadlineDate = LocalDate.of(2024, 3, 31), category = 8, purchaseInvoice = null, payment = 15),
            SingleExpense(id = 14, name = "Spese postali", amount = 7.5f, deadlineDate = LocalDate.of(2024, 4, 1), category = 8, purchaseInvoice = 17, payment = 16),
            SingleExpense(id = 34, name = "Ricarica telefonica aziendale", amount = 20f, deadlineDate = LocalDate.of(2024, 3, 30), category = 6, purchaseInvoice = null, payment = 16),
            SingleExpense(id = 35, name = "Spuntino rapido trasferta", amount = 12.5f, deadlineDate = LocalDate.of(2024, 4, 2), category = 10, purchaseInvoice = null, payment = 16),
            SingleExpense(id = 15, name = "Lampadine ufficio", amount = 30f, deadlineDate = LocalDate.of(2024, 4, 5), category = 6, purchaseInvoice = 22, payment = 17),
            SingleExpense(id = 23, name = "Lavaggio furgone", amount = 20f, deadlineDate = LocalDate.of(2024, 4, 5), category = 7, purchaseInvoice = null, payment = 17),
            SingleExpense(id = 47, name = "Acquisto dominio web", amount = 15f, deadlineDate = LocalDate.of(2026, 2, 10), category = 10, purchaseInvoice = 28, payment = 18),
            SingleExpense(id = 50, name = "Interessi passivi", amount = 4.25f, deadlineDate = LocalDate.of(2026, 2, 10), category = 8, purchaseInvoice = null, payment = 20),
            SingleExpense(id = 40, name = "Acconto fiera 2025", amount = 2000f, deadlineDate = LocalDate.of(2025, 1, 1), category = 10, purchaseInvoice = 13, payment = 21),
            SingleExpense(id = 46, name = "Sanzione stradale", amount = 168f, deadlineDate = LocalDate.of(2024, 5, 15), category = 4, purchaseInvoice = null, payment = 23),
            SingleExpense(id = 44, name = "Software licenza perpetua", amount = 1200f, deadlineDate = LocalDate.of(2024, 4, 12), category = 10, purchaseInvoice = 23, payment = 25),
            SingleExpense(id = 51, name = "Rifornimento materiale", amount = 20f, deadlineDate = LocalDate.of(2026, 2, 12), category = 2, purchaseInvoice = 51, payment = 26),
            SingleExpense(id = 52, name = "F", amount = 1000f, deadlineDate = LocalDate.of(2026, 2, 12), category = 8, purchaseInvoice = 52, payment = 27),
            SingleExpense(id = 53, name = "Cancelleria", amount = 120.67f, deadlineDate = LocalDate.of(2026, 2, 28), category = 8, purchaseInvoice = 53, payment = 28),
            SingleExpense(id = 54, name = "Scarpe", amount = 80f, deadlineDate = LocalDate.of(2026, 3, 31), category = 11, purchaseInvoice = 54, payment = 29),
            SingleExpense(id = 36, name = "Consulenza legale urgente", amount = 1500f, deadlineDate = LocalDate.of(2024, 5, 1), category = 9, purchaseInvoice = 3, payment = null),
            SingleExpense(id = 37, name = "Rifornimento extra", amount = 60f, deadlineDate = LocalDate.of(2024, 4, 10), category = 4, purchaseInvoice = 8, payment = null),
            SingleExpense(id = 38, name = "Penale ritardo consegna", amount = 50f, deadlineDate = LocalDate.of(2024, 3, 1), category = 10, purchaseInvoice = null, payment = null),
            SingleExpense(id = 42, name = "Correzione errore contabile", amount = -10f, deadlineDate = LocalDate.of(2026, 2, 10), category = 10, purchaseInvoice = null, payment = null),
            SingleExpense(id = 43, name = "Spesa d'emergenza guasto", amount = 850f, deadlineDate = LocalDate.of(2026, 2, 10), category = 7, purchaseInvoice = 18, payment = null),
            SingleExpense(id = 48, name = "Campionario materiali", amount = 0f, deadlineDate = LocalDate.of(2024, 2, 1), category = 10, purchaseInvoice = 33, payment = null),
            SingleExpense(id = 49, name = "Assicurazione integrativa", amount = 300f, deadlineDate = LocalDate.of(2024, 6, 1), category = 9, purchaseInvoice = 38, payment = null)
        )
    ...
    suspend fun seedRecurringExpense(repository: Repository){
        val recurringExpenses = listOf(
            ...
            RecurringExpense(id = 4, name = "Assicurazione Furgone 1", frequency = FrequencyType.valueOf("Anno"), amount = 800f, category = 9, endDate = LocalDate.of(2025, 12, 31), purchaseInvoice = 20),
            ...
            RecurringExpense(id = 6, name = "Abbonamento Gestionale", frequency = FrequencyType.valueOf("Mese"), amount = 45f, category = 10, endDate = null, purchaseInvoice = 30),
            RecurringExpense(id = 7, name = "Connessione Fibra Ottica", frequency = FrequencyType.valueOf("Mese"), amount = 35f, category = 6, endDate = null, purchaseInvoice = 35),
            ...
            RecurringExpense(id = 10, name = "Commercialista", frequency = FrequencyType.valueOf("Mese"), amount = 250f, category = 9, endDate = null, purchaseInvoice = 4),
            RecurringExpense(id = 11, name = "Hosting Sito Web", frequency = FrequencyType.valueOf("Anno"), amount = 120f, category = 10, endDate = LocalDate.of(2025, 6, 1), purchaseInvoice = 9),
            RecurringExpense(id = 12, name = "Licenza Office 365", frequency = FrequencyType.valueOf("Mese"), amount = 12.5f, category = 10, endDate = null, purchaseInvoice = 14),
            ...
            RecurringExpense(id = 14, name = "Canone POS", frequency = FrequencyType.valueOf("Mese"), amount = 15f, category = 8, endDate = null, purchaseInvoice = 24),
            ...
            RecurringExpense(id = 20, name = "Sanificazione Periodica", frequency = FrequencyType.valueOf("Mese"), amount = 200f, category = 6, endDate = LocalDate.of(2024, 8, 1), purchaseInvoice = 3),
            ...
            RecurringExpense(id = 24, name = "Leasing Furgone 1", frequency = FrequencyType.valueOf("Mese"), amount = 450f, category = 7, endDate = LocalDate.of(2026, 12, 31), purchaseInvoice = 23),
            ...
            RecurringExpense(id = 31, name = "Software Calcolo Termico", frequency = FrequencyType.valueOf("Anno"), amount = 350f, category = 10, endDate = LocalDate.of(2025, 2, 1), purchaseInvoice = 7),
            ...
            RecurringExpense(id = 33, name = "Servizio Vigilanza Notturna", frequency = FrequencyType.valueOf("Mese"), amount = 80f, category = 3, endDate = null, purchaseInvoice = 17),
            ...
            RecurringExpense(id = 38, name = "Donazione periodica ONLUS", frequency = FrequencyType.valueOf("Mese"), amount = 10f, category = 10, endDate = null, purchaseInvoice = null),
            ...
            RecurringExpense(id = 45, name = "Box Cloud Extra", frequency = FrequencyType.valueOf("Mese"), amount = 2.99f, category = 10, endDate = null, purchaseInvoice = null),
            ...
            RecurringExpense(id = 49, name = "Noleggio Scala Aerea", frequency = FrequencyType.valueOf("Settimana"), amount = 300f, category = 7, endDate = LocalDate.of(2024, 4, 20), purchaseInvoice = 11),
            ...
            RecurringExpense(id = 51, name = "Prestito", frequency = FrequencyType.valueOf("Mese"), amount = 22000f, category = 10, endDate = LocalDate.of(2029, 3, 1), purchaseInvoice = null)
        )
    ...
    suspend fun seedRecurringPayment(repository : Repository){
        val recurringPayments = listOf(
            RecurringPayment(payment = 1, recurringExpense = 1),
            RecurringPayment(payment = 5, recurringExpense = 1),
            RecurringPayment(payment = 6, recurringExpense = 2),
            RecurringPayment(payment = 10, recurringExpense = 2),
            RecurringPayment(payment = 11, recurringExpense = 3),
            RecurringPayment(payment = 15, recurringExpense = 3),
            RecurringPayment(payment = 16, recurringExpense = 4),
            RecurringPayment(payment = 20, recurringExpense = 4),
            RecurringPayment(payment = 21, recurringExpense = 5),
            RecurringPayment(payment = 25, recurringExpense = 5),
            RecurringPayment(payment = 26, recurringExpense = 6),
            RecurringPayment(payment = 4, recurringExpense = 10),
            RecurringPayment(payment = 9, recurringExpense = 11),
            RecurringPayment(payment = 14, recurringExpense = 12),
            RecurringPayment(payment = 19, recurringExpense = 13),
            RecurringPayment(payment = 24, recurringExpense = 14),
            RecurringPayment(payment = 29, recurringExpense = 15),
            RecurringPayment(payment = 3, recurringExpense = 20),
            RecurringPayment(payment = 8, recurringExpense = 21),
            RecurringPayment(payment = 13, recurringExpense = 22),
            RecurringPayment(payment = 18, recurringExpense = 23),
            RecurringPayment(payment = 23, recurringExpense = 24),
            RecurringPayment(payment = 28, recurringExpense = 25),
            RecurringPayment(payment = 2, recurringExpense = 30),
            RecurringPayment(payment = 7, recurringExpense = 31),
            RecurringPayment(payment = 12, recurringExpense = 32),
            RecurringPayment(payment = 17, recurringExpense = 33),
            RecurringPayment(payment = 22, recurringExpense = 34),
            RecurringPayment(payment = 27, recurringExpense = 35)
        )
    ...
    suspend fun seedCustomers(repository :Repository){
        val customers = listOf(
            Customer(
                ...
                avarageCollectionTime = 30.0f,
                collectionCount = 25,
                residence = 26,
                reference = 7
            ),
            Customer(cf = "01234567891", name = "Luigi", mail = "amministrazione@tecno.it", avarageCollectionTime = 60.5f, collectionCount = 12, residence = 27, reference = 8),
            Customer(cf = "01234567892", name = "Carla", mail = "carla@ristorante.it", avarageCollectionTime = 15.0f, collectionCount = 40, residence = 28, reference = 9),
            Customer(cf = "01234567893", name = "Paolo", mail = "direzione@logistica.it", avarageCollectionTime = 90.0f, collectionCount = 5, residence = 29, reference = null),
            Customer(cf = "01234567894", name = "Sonia", mail = "commerciale@moda.it", avarageCollectionTime = 25.5f, collectionCount = 18, residence = 30, reference = 10),
            Customer(cf = "01234567895", name = "Fabio", mail = "fabio@officina.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 31, reference = 11),
            Customer(cf = "01234567896", name = "Monica", mail = "info@hotelstella.it", avarageCollectionTime = 20.0f, collectionCount = 30, residence = 32, reference = 12),
            Customer(cf = "01234567897", name = "Enrico", mail = "enrico@ferramenta.it", avarageCollectionTime = 45.0f, collectionCount = 10, residence = 33, reference = 13),
            Customer(cf = "01234567898", name = "Cinzia", mail = "cinzia@studiolegale.it", avarageCollectionTime = 10.0f, collectionCount = 50, residence = 34, reference = 14),
            Customer(cf = "01234567899", name = "Massimo", mail = "info@pizzeria.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 35, reference = 15),
            Customer(cf = "01234567900", name = "Stefania", mail = "ordini@pasticceria.it", avarageCollectionTime = 12.0f, collectionCount = 22, residence = 36, reference = 1),
            Customer(cf = "01234567901", name = "Roberto", mail = "r.galli@impresa.it", avarageCollectionTime = 35.0f, collectionCount = 8, residence = 37, reference = 2),
            Customer(cf = "01234567902", name = "Alice", mail = "alice@boutique.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 38, reference = 3),
            Customer(cf = "01234567903", name = "Daniele", mail = "daniele@laboratorio.it", avarageCollectionTime = 15.0f, collectionCount = 15, residence = 39, reference = null),
            Customer(cf = "01234567904", name = "Simona", mail = "simona@estetica.it", avarageCollectionTime = 28.0f, collectionCount = 6, residence = 40, reference = 4),
            Customer(cf = "01234567905", name = "Giovanni", mail = "giovanni@falegnameria.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 41, reference = 5),
            Customer(cf = "01234567906", name = "Beatrice", mail = "info@asilo.it", avarageCollectionTime = 40.0f, collectionCount = 4, residence = 42, reference = 6),
            Customer(cf = "01234567907", name = "Claudio", mail = "claudio@bar.it", avarageCollectionTime = 18.5f, collectionCount = 20, residence = 43, reference = 7),
            Customer(cf = "01234567908", name = "Federica", mail = "fede@fioraio.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 44, reference = 8),
            Customer(cf = "01234567909", name = "Umberto", mail = "umberto@palestra.it", avarageCollectionTime = 50.0f, collectionCount = 10, residence = 45, reference = 9),
            Customer(cf = "01234567910", name = "Ilaria", mail = "ilaria@farmacia.it", avarageCollectionTime = 10.0f, collectionCount = 60, residence = 46, reference = 10),
            Customer(cf = "01234567911", name = "Antonio", mail = "antonio@carrozzeria.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 47, reference = 11),
            Customer(cf = "01234567912", name = "Valeria", mail = "valeria@dentista.it", avarageCollectionTime = 30.0f, collectionCount = 5, residence = 48, reference = 12),
            Customer(cf = "01234567913", name = "Giacomo", mail = "giacomo@studio.it", avarageCollectionTime = 15.0f, collectionCount = 12, residence = 49, reference = 13),
            Customer(cf = "01234567914", name = "Rosa", mail = "rosa@parrucchiere.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 50, reference = 14),
            Customer(cf = "12345567890", name = "TechNova", mail = "technova.solutions@legalmail.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 102, reference = null),
            Customer(cf = "BNCCHR90S05F205J", name = "Chiara", mail = "chiara.bianchi@gmail.com", avarageCollectionTime = 5.0f, collectionCount = 1, residence = 15, reference = 12),
            Customer(cf = "BNCHGL92S62F205P", name = "Giulia", mail = "giulia.bianchi.92@example.com", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 103, reference = 16),
            Customer(cf = "BNCLCU75B10L219Z", name = "Luca", mail = "luca.bianchi@fastweb.it", avarageCollectionTime = 30.2f, collectionCount = 12, residence = 3, reference = 2),
            Customer(cf = "BRNMRT89Q15F205L", name = "Marta", mail = "marta.bruno@outlook.com", avarageCollectionTime = 25.0f, collectionCount = 2, residence = 13, reference = 10),
            Customer(cf = "CLMSRA95I20F205P", name = "Sara", mail = "sara.colombo@virgilio.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 9, reference = 7),
            Customer(cf = "CRSMCO82A01F205G", name = "Marco", mail = "marco.caruso@gmail.com", avarageCollectionTime = 22.0f, collectionCount = 4, residence = 18, reference = 15),
            Customer(cf = "DCNALE91G15F205A", name = "Alessandro", mail = "ale.de_luca@tiscali.it", avarageCollectionTime = 33.0f, collectionCount = 1, residence = 24, reference = 5),
            Customer(cf = "ESPGNN80A01F839U", name = "Gennaro", mail = "gennaro.expo@napoli.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 107, reference = null),
            Customer(cf = "ESPSLV88G05F205B", name = "Silvia", mail = "silvia.esposito@email.it", avarageCollectionTime = 20.0f, collectionCount = 5, residence = 7, reference = 5),
            Customer(cf = "FRRELE92E25F205D", name = "Elena", mail = "elena.ferrari@outlook.it", avarageCollectionTime = 10.0f, collectionCount = 1, residence = 5, reference = 4),
            Customer(cf = "GLLPTR81R25F205K", name = "Pietro", mail = "pietro.galli@tiscali.it", avarageCollectionTime = 30.0f, collectionCount = 10, residence = 14, reference = 11),
            Customer(cf = "GLLRBT85D15F205E", name = "Roberto", mail = "roby.gialli@libero.it", avarageCollectionTime = 45.0f, collectionCount = 2, residence = 4, reference = 3),
            Customer(cf = "GRCGRG72P05F205M", name = "Giorgio", mail = "giorgio.greco@libero.it", avarageCollectionTime = 27.5f, collectionCount = 2, residence = 12, reference = 9),
            Customer(cf = "GTTVAL80H25F205Z", name = "Valentina", mail = "valen.gatti@gmail.com", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 25, reference = 6),
            Customer(cf = "LBRGIA93B10F205F", name = "Giulia", mail = "giulia.lombardi@outlook.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 19, reference = 1),
            Customer(cf = "MNNFRN85D30F205D", name = "Francesca", mail = "fra.manna@email.it", avarageCollectionTime = 11.0f, collectionCount = 2, residence = 21, reference = 2),
            Customer(cf = "MRNAND75T15F205I", name = "Andrea", mail = "andrea.marini@email.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 16, reference = 13),
            Customer(cf = "MRNLRA83M25F205N", name = "Laura", mail = "laura.marino@email.it", avarageCollectionTime = 18.2f, collectionCount = 3, residence = 11, reference = null),
            Customer(cf = "MRTLSN78P05D612O", name = "Alessandro", mail = "a.martini.78@example.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 104, reference = null),
            Customer(cf = "PLMMRT84F05F205B", name = "Martina", mail = "martina.palumbo@libero.it", avarageCollectionTime = 19.0f, collectionCount = 7, residence = 23, reference = 4),
            Customer(cf = "RCCDVD78L15F205O", name = "Davide", mail = "davide.ricci@gmail.com", avarageCollectionTime = 60.0f, collectionCount = 1, residence = 10, reference = 8),
            Customer(cf = "RMNMTT82H10F205A", name = "Matteo", mail = "matteo.romano@tiscali.it", avarageCollectionTime = 12.5f, collectionCount = 8, residence = 8, reference = 6),
            Customer(cf = "RSSFRN70F30F205C", name = "Franco", mail = "franco.russo@gmail.com", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 6, reference = null),
            Customer(cf = "RSSMRA80A01F205H", name = "Mario", mail = "mario.rossi@email.it", avarageCollectionTime = 15.5f, collectionCount = 4, residence = 1, reference = 1),
            Customer(cf = "RSSMRC85E14H501Z", name = "Marco", mail = "marco.rossi.test@example.it", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 101, reference = null),
            Customer(cf = "RZZSTE70C20F205E", name = "Stefano", mail = "stefano.rizzi@fastweb.it", avarageCollectionTime = 40.5f, collectionCount = 3, residence = 20, reference = null),
            Customer(cf = "SRTMRE77E25F205C", name = "Emanuele", mail = "ema.serra@gmail.com", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 22, reference = 3),
            Customer(cf = "VLNSOF88U25F205H", name = "Sofia", mail = "sofia.valenti@libero.it", avarageCollectionTime = 14.0f, collectionCount = 6, residence = 17, reference = 14),
            Customer(cf = "VRDNNA90C20F205G", name = "Anna", mail = "anna.verdi@gmail.com", avarageCollectionTime = 0.0f, collectionCount = 0, residence = 2, reference = null)
    ...
    suspend fun seedCompany(repository: Repository){
        val companies = listOf(
            Company(uniqueCode = "ASI2222", companyName = "Asilo Il Grillo", vatNumber = "1234567906", cf = "1234567906"),
            Company(uniqueCode = "BAR3333", companyName = "Bar Centrale snc", vatNumber = "1234567907", cf = "1234567907"),
            Company(uniqueCode = "BOU5656", companyName = "Boutique Alice", vatNumber = "1234567902", cf = "1234567902"),
            Company(uniqueCode = "CAR7777", companyName = "Carrozzeria Antonio", vatNumber = "1234567911", cf = "1234567911"),
            Company(uniqueCode = "DEN8888", companyName = "Studio Dentistico Val.", vatNumber = "1234567912", cf = "1234567912"),
            Company(uniqueCode = "EDI1234", companyName = "Edil Milano SRL", vatNumber = "1234567890", cf = "1234567890"),
            Company(uniqueCode = "EST9090", companyName = "Centro Estetico Simona", vatNumber = "1234567904", cf = "1234567904"),
            Company(uniqueCode = "FAL1111", companyName = "Falegnameria Giovanni", vatNumber = "1234567905", cf = "1234567905"),
            Company(uniqueCode = "FAR6666", companyName = "Farmacia San Luca", vatNumber = "1234567910", cf = "1234567910"),
            Company(uniqueCode = "FER5566", companyName = "Ferramenta Rossi snc", vatNumber = "1234567897", cf = "1234567897"),
            Company(uniqueCode = "FIO4444", companyName = "Fioraio Federica", vatNumber = "1234567908", cf = "1234567908"),
            Company(uniqueCode = "HOT3344", companyName = "Hotel Stella Maris", vatNumber = "1234567896", cf = "1234567896"),
            Company(uniqueCode = "IMP3434", companyName = "Impresa Costruzioni Galli", vatNumber = "1234567901", cf = "1234567901"),
            Company(uniqueCode = "K7X9P3J", companyName = "TechNova Solutions S.r.l.", vatNumber = "12345567890", cf = "12345567890"),
            Company(uniqueCode = "LAB7878", companyName = "Laboratorio Analisi", vatNumber = "1234567903", cf = "1234567903"),
            Company(uniqueCode = "LEG7788", companyName = "Studio Legale Cinzia", vatNumber = "1234567898", cf = "1234567898"),
            Company(uniqueCode = "LOG3456", companyName = "Logistica Express SPA", vatNumber = "1234567893", cf = "1234567893"),
            Company(uniqueCode = "MOD7890", companyName = "Moda Italia SRL", vatNumber = "1234567894", cf = "1234567894"),
            Company(uniqueCode = "OFF1122", companyName = "Auto Officina Fabio", vatNumber = "1234567895", cf = "1234567895"),
            Company(uniqueCode = "PAL5555", companyName = "Palestra BodyMind", vatNumber = "1234567909", cf = "1234567909"),
            Company(uniqueCode = "PAR0000", companyName = "Parrucchiere Rosa", vatNumber = "1234567914", cf = "1234567914"),
            Company(uniqueCode = "PAS1212", companyName = "Pasticceria Dolci", vatNumber = "1234567900", cf = "1234567900"),
            Company(uniqueCode = "PIZ9900", companyName = "Pizzeria La Bufala", vatNumber = "1234567899", cf = "1234567899"),
            Company(uniqueCode = "RIS9012", companyName = "Ristorante Da Mario", vatNumber = "1234567892", cf = "1234567892"),
            Company(uniqueCode = "STU9999", companyName = "Studio Architettura G.", vatNumber = "1234567913", cf = "1234567913"),
            Company(uniqueCode = "TEC5678", companyName = "Tecno Impianti SAS", vatNumber = "1234567891", cf = "1234567891")
        )
    ...
    suspend fun seedPhoneNumber(repository: Repository){
        val phoneNumbers = listOf(
            ...
            PhoneNumber(number = "21234567", text = "Centralino Sede", customer = "1234567890"),
            PhoneNumber(number = "39445566", text = "Ufficio", customer = "01234567891"),
            PhoneNumber(number = "06 9876543", text = "Fisso", customer = "012345567890"),
    ...
    suspend fun seedCustomerProvision(repository: Repository){
        val customerProvisions = listOf(
            ...
            CustomerProvision(material = 16, customer = "1234567890", quantity = 3f),
            ...
            CustomerProvision(material = 26, customer = "1234567890", quantity = 1f),
            CustomerProvision(material = 27, customer = "1234567891", quantity = 2f),
            CustomerProvision(material = 28, customer = "1234567892", quantity = 6f),
            CustomerProvision(material = 29, customer = "1234567893", quantity = 1f),
            CustomerProvision(material = 30, customer = "1234567894", quantity = 8f),
            CustomerProvision(material = 31, customer = "1234567895", quantity = 10f),
            CustomerProvision(material = 32, customer = "1234567896", quantity = 2f),
            CustomerProvision(material = 33, customer = "1234567897", quantity = 4f),
            CustomerProvision(material = 34, customer = "1234567898", quantity = 1f),
            CustomerProvision(material = 35, customer = "1234567899", quantity = 1f),
            CustomerProvision(material = 36, customer = "1234567900", quantity = 0.5f),
            CustomerProvision(material = 37, customer = "1234567901", quantity = 0.75f),
            CustomerProvision(material = 38, customer = "1234567902", quantity = 1000f),
            CustomerProvision(material = 39, customer = "1234567903", quantity = 1f),
            CustomerProvision(material = 40, customer = "1234567904", quantity = 2.5f),
            CustomerProvision(material = 41, customer = "1234567905", quantity = 1f),
            CustomerProvision(material = 42, customer = "1234567906", quantity = 1f),
            CustomerProvision(material = 43, customer = "1234567907", quantity = 0.2f),
            CustomerProvision(material = 44, customer = "1234567908", quantity = 3f),
            CustomerProvision(material = 45, customer = "1234567909", quantity = 1f),
            CustomerProvision(material = 46, customer = "1234567910", quantity = 5f),
            CustomerProvision(material = 47, customer = "1234567911", quantity = 1f),
            CustomerProvision(material = 48, customer = "1234567912", quantity = 1.25f),
            CustomerProvision(material = 49, customer = "1234567913", quantity = 1f),
            CustomerProvision(material = 50, customer = "1234567914", quantity = 0.5f),
    ...
    suspend fun seedWorksite(repository: Repository){
        val workSites = listOf(
            ...
            WorkSite(id = 11, startDate = LocalDate.of(2023, 1, 10), address = 56, endDate = LocalDate.of(2023, 12, 31), manager = 6, customer = "1234567890"),
            WorkSite(id = 12, startDate = LocalDate.of(2023, 1, 10), address = 57, endDate = null, manager = 7, customer = "1234567890"),
            WorkSite(id = 13, startDate = LocalDate.of(2023, 1, 10), address = 58, endDate = null, manager = 8, customer = "1234567890"),
            WorkSite(id = 14, startDate = LocalDate.of(2024, 1, 10), address = 70, endDate = null, manager = 9, customer = "1234567890"),
            WorkSite(id = 15, startDate = LocalDate.of(2024, 1, 10), address = 84, endDate = null, manager = 10, customer = "1234567890"),
            ...
            WorkSite(id = 27, startDate = LocalDate.of(2023, 11, 1), address = 26, endDate = LocalDate.of(2024, 2, 1), manager = 1, customer = "1234567890"),
            WorkSite(id = 28, startDate = LocalDate.of(2023, 12, 15), address = 27, endDate = LocalDate.of(2024, 3, 15), manager = 2, customer = "1234567891"),
            WorkSite(id = 29, startDate = LocalDate.of(2024, 2, 1), address = 28, endDate = null, manager = 3, customer = "1234567892"),
            WorkSite(id = 30, startDate = LocalDate.of(2024, 2, 20), address = 29, endDate = null, manager = 4, customer = "1234567893"),
            WorkSite(id = 31, startDate = LocalDate.of(2024, 3, 1), address = 30, endDate = null, manager = 5, customer = "1234567894"),
            WorkSite(id = 32, startDate = LocalDate.of(2023, 4, 1), address = 31, endDate = LocalDate.of(2023, 5, 1), manager = 6, customer = "1234567895"),
            WorkSite(id = 33, startDate = LocalDate.of(2023, 5, 15), address = 32, endDate = LocalDate.of(2023, 8, 15), manager = 7, customer = "1234567896"),
            WorkSite(id = 34, startDate = LocalDate.of(2023, 7, 1), address = 33, endDate = LocalDate.of(2023, 9, 1), manager = 8, customer = "1234567897"),
            WorkSite(id = 35, startDate = LocalDate.of(2023, 8, 15), address = 34, endDate = LocalDate.of(2023, 11, 15), manager = 9, customer = "1234567898"),
            WorkSite(id = 36, startDate = LocalDate.of(2024, 4, 1), address = 35, endDate = null, manager = 10, customer = "1234567899"),
            WorkSite(id = 37, startDate = LocalDate.of(2024, 4, 15), address = 36, endDate = null, manager = 11, customer = "1234567900"),
            WorkSite(id = 38, startDate = LocalDate.of(2024, 5, 1), address = 37, endDate = null, manager = 12, customer = "1234567901"),
            WorkSite(id = 39, startDate = LocalDate.of(2023, 6, 1), address = 38, endDate = LocalDate.of(2023, 7, 1), manager = 13, customer = "1234567902"),
            WorkSite(id = 40, startDate = LocalDate.of(2023, 8, 20), address = 39, endDate = LocalDate.of(2023, 10, 20), manager = 14, customer = "1234567903"),
            WorkSite(id = 41, startDate = LocalDate.of(2023, 11, 5), address = 40, endDate = LocalDate.of(2024, 1, 5), manager = 15, customer = "1234567904"),
            WorkSite(id = 42, startDate = LocalDate.of(2024, 5, 10), address = 41, endDate = null, manager = 1, customer = "1234567905"),
            WorkSite(id = 43, startDate = LocalDate.of(2024, 5, 20), address = 42, endDate = null, manager = 2, customer = "1234567906"),
            WorkSite(id = 44, startDate = LocalDate.of(2024, 6, 1), address = 43, endDate = null, manager = 3, customer = "1234567907"),
            WorkSite(id = 45, startDate = LocalDate.of(2023, 2, 1), address = 44, endDate = LocalDate.of(2023, 3, 1), manager = 4, customer = "1234567908"),
            WorkSite(id = 46, startDate = LocalDate.of(2023, 4, 10), address = 45, endDate = LocalDate.of(2023, 6, 10), manager = 5, customer = "1234567909"),
            WorkSite(id = 47, startDate = LocalDate.of(2023, 7, 15), address = 46, endDate = LocalDate.of(2023, 9, 15), manager = 6, customer = "1234567910"),
            WorkSite(id = 48, startDate = LocalDate.of(2024, 1, 10), address = 47, endDate = null, manager = 7, customer = "1234567911"),
            WorkSite(id = 49, startDate = LocalDate.of(2024, 2, 15), address = 48, endDate = null, manager = 8, customer = "1234567912"),
            WorkSite(id = 50, startDate = LocalDate.of(2024, 3, 20), address = 49, endDate = null, manager = 9, customer = "1234567913"),
            WorkSite(id = 51, startDate = LocalDate.of(2024, 4, 10), address = 50, endDate = null, manager = 10, customer = "1234567914"),
    ...
    suspend fun seedJob(repository: Repository){
        val jobs = listOf(
            Job(id = 1, date = LocalDate.of(2023, 10, 10), startTime = LocalTime.of(8, 30, 0), description = "Installazione rapida prese", peopleNumber = 2, address = 15, endTime = LocalTime.of(12, 30, 0), electic = true, alarm = false, airConditioning = false, customer = "BNCCHR90S05F205J", workSite = 10),
            Job(id = 2, date = LocalDate.of(2023, 10, 10), startTime = LocalTime.of(14, 0, 0), description = "Collaudo finale impianto", peopleNumber = 1, address = 15, endTime = LocalTime.of(18, 0, 0), electic = true, alarm = true, airConditioning = false, customer = "BNCCHR90S05F205J", workSite = 10),
            Job(id = 3, date = LocalDate.of(2023, 5, 10), startTime = LocalTime.of(8, 0, 0), description = "Cablaggio strutturato uffici", peopleNumber = 4, address = 56, endTime = LocalTime.of(17, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567890", workSite = 11),
            Job(id = 4, date = LocalDate.of(2024, 2, 15), startTime = LocalTime.of(9, 0, 0), description = "Manutenzione climatizzatori industriali", peopleNumber = 2, address = 70, endTime = LocalTime.of(13, 0, 0), electic = false, alarm = false, airConditioning = true, customer = "1234567890", workSite = 14),
            Job(id = 5, date = LocalDate.of(2024, 3, 20), startTime = LocalTime.of(10, 0, 0), description = "Verifica sensori perimetrali", peopleNumber = 1, address = 84, endTime = LocalTime.of(12, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "1234567890", workSite = 15),
            Job(id = 6, date = LocalDate.of(2024, 1, 15), startTime = LocalTime.of(8, 30, 0), description = "Riparazione citofono guasto", peopleNumber = 1, address = 1, endTime = LocalTime.of(10, 30, 0), electic = true, alarm = false, airConditioning = false, customer = "RSSMRA80A01F205H", workSite = null),
            Job(id = 7, date = LocalDate.of(2024, 1, 20), startTime = LocalTime.of(14, 30, 0), description = "Sostituzione batteria allarme", peopleNumber = 1, address = 2, endTime = LocalTime.of(16, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "VRDNNA90C20F205G", workSite = null),
            Job(id = 8, date = LocalDate.of(2023, 6, 15), startTime = LocalTime.of(8, 0, 0), description = "Rifacimento completo elettrico e condizionamento", peopleNumber = 3, address = 3, endTime = LocalTime.of(18, 0, 0), electic = true, alarm = false, airConditioning = true, customer = "BNCLCU75B10L219Z", workSite = 18),
            Job(id = 9, date = LocalDate.of(2022, 1, 10), startTime = LocalTime.of(8, 0, 0), description = "Tracciatura impianti", peopleNumber = 2, address = 10, endTime = LocalTime.of(12, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 1),
            Job(id = 10, date = LocalDate.of(2022, 1, 10), startTime = LocalTime.of(13, 0, 0), description = "Posa tubazioni", peopleNumber = 2, address = 10, endTime = LocalTime.of(17, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 1),
            Job(id = 11, date = LocalDate.of(2024, 3, 1), startTime = LocalTime.of(8, 30, 0), description = "Sopralluogo tecnico per nuovo impianto", peopleNumber = 2, address = 5, endTime = LocalTime.of(12, 0, 0), electic = true, alarm = true, airConditioning = true, customer = "FRRELE92E25F205D", workSite = 8),
            Job(id = 12, date = LocalDate.of(2024, 3, 25), startTime = LocalTime.of(9, 0, 0), description = "Sostituzione termostato", peopleNumber = 1, address = 12, endTime = LocalTime.of(11, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "GRCGRG72P05F205M", workSite = 9),
            Job(id = 13, date = LocalDate.of(2023, 11, 20), startTime = LocalTime.of(10, 0, 0), description = "Controllo periodico allarme", peopleNumber = 1, address = 4, endTime = LocalTime.of(12, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "GLLRBT85D15F205E", workSite = 19),
            Job(id = 14, date = LocalDate.of(2024, 2, 10), startTime = LocalTime.of(8, 0, 0), description = "Installazione split camera", peopleNumber = 1, address = 7, endTime = LocalTime.of(10, 0, 0), electic = false, alarm = false, airConditioning = true, customer = "ESPSLV88G05F205B", workSite = 21),
            Job(id = 15, date = LocalDate.of(2023, 9, 5), startTime = LocalTime.of(14, 0, 0), description = "Allacciamento cucina", peopleNumber = 2, address = 9, endTime = LocalTime.of(16, 30, 0), electic = true, alarm = false, airConditioning = false, customer = "CLMSRA95I20F205P", workSite = 23),
            Job(id = 16, date = LocalDate.of(2023, 12, 5), startTime = LocalTime.of(8, 30, 0), description = "Montaggio corpi illuminanti esterni", peopleNumber = 2, address = 14, endTime = LocalTime.of(13, 30, 0), electic = true, alarm = false, airConditioning = false, customer = "GLLPTR81R25F205K", workSite = 26),
            Job(id = 17, date = LocalDate.of(2023, 4, 15), startTime = LocalTime.of(8, 0, 0), description = "Revisione quadri elettrici officina", peopleNumber = 2, address = 31, endTime = LocalTime.of(12, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567895", workSite = 32),
            Job(id = 18, date = LocalDate.of(2023, 6, 10), startTime = LocalTime.of(21, 0, 0), description = "Intervento emergenza notturna guasto luci", peopleNumber = 2, address = 32, endTime = LocalTime.of(23, 30, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567896", workSite = 33),
            Job(id = 19, date = LocalDate.of(2023, 10, 1), startTime = LocalTime.of(9, 0, 0), description = "Configurazione rete telecamere IP", peopleNumber = 3, address = 34, endTime = LocalTime.of(18, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "1234567898", workSite = 35),
            Job(id = 20, date = LocalDate.of(2026, 2, 12), startTime = LocalTime.of(8, 0, 0), description = "Smontato lampadari", peopleNumber = 2, address = 12, endTime = LocalTime.of(17, 33, 21), electic = true, alarm = false, airConditioning = false, customer = "GRCGRG72P05F205M", workSite = null),
            Job(id = 21, date = LocalDate.of(2026, 2, 17), startTime = LocalTime.of(9, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 105, endTime = LocalTime.of(11, 0, 0), electic = true, alarm = false, airConditioning = true, customer = "BNCCHR90S05F205J", workSite = 52),
            Job(id = 22, date = LocalDate.of(2026, 2, 17), startTime = LocalTime.of(9, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 106, endTime = LocalTime.of(11, 0, 0), electic = true, alarm = false, airConditioning = false, customer = null, workSite = 54),
            Job(id = 95, date = LocalDate.of(2022, 3, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 10, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 2),
            Job(id = 96, date = LocalDate.of(2022, 3, 3), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 64, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 3),
            Job(id = 97, date = LocalDate.of(2022, 3, 4), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 3, address = 51, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RSSMRA80A01F205H", workSite = 4),
            Job(id = 98, date = LocalDate.of(2023, 3, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 54, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "VRDNNA90C20F205G", workSite = 5),
            Job(id = 99, date = LocalDate.of(2022, 5, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 3, address = 71, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "BNCLCU75B10L219Z", workSite = 6),
            Job(id = 100, date = LocalDate.of(2022, 9, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 2, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "VRDNNA90C20F205G", workSite = 7),
            Job(id = 103, date = LocalDate.of(2023, 6, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 56, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567890", workSite = 12),
            Job(id = 104, date = LocalDate.of(2024, 1, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 3, address = 57, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567890", workSite = 13),
            Job(id = 105, date = LocalDate.of(2025, 12, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 66, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "RSSMRA80A01F205H", workSite = 16),
            Job(id = 106, date = LocalDate.of(2022, 3, 2), startTime = LocalTime.of(11, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 2, endTime = LocalTime.of(12, 30, 0), electic = false, alarm = true, airConditioning = false, customer = "VRDNNA90C20F205G", workSite = 17),
            Job(id = 107, date = LocalDate.of(2022, 8, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 60, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "RSSFRN70F30F205C", workSite = 20),
            Job(id = 108, date = LocalDate.of(2022, 3, 7), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 62, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "RMNMTT82H10F205A", workSite = 22),
            Job(id = 109, date = LocalDate.of(2022, 4, 8), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 65, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "MRNLRA83M25F205N", workSite = 24),
            Job(id = 110, date = LocalDate.of(2022, 5, 9), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 3, address = 68, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "BRNMRT89Q15F205L", workSite = 25),
            Job(id = 111, date = LocalDate.of(2022, 6, 12), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 97, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = true, airConditioning = false, customer = "1234567890", workSite = 27),
            Job(id = 112, date = LocalDate.of(2022, 7, 13), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 72, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567891", workSite = 28),
            Job(id = 113, date = LocalDate.of(2022, 8, 14), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 73, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567892", workSite = 29),
            Job(id = 114, date = LocalDate.of(2022, 9, 12), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 74, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567893", workSite = 30),
            Job(id = 115, date = LocalDate.of(2022, 10, 15), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 75, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567894", workSite = 31),
            Job(id = 116, date = LocalDate.of(2022, 11, 16), startTime = LocalTime.of(17, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 78, endTime = LocalTime.of(18, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567897", workSite = 34),
            Job(id = 117, date = LocalDate.of(2022, 12, 17), startTime = LocalTime.of(18, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 80, endTime = LocalTime.of(19, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567899", workSite = 36),
            Job(id = 118, date = LocalDate.of(2023, 2, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 81, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567900", workSite = 37),
            Job(id = 119, date = LocalDate.of(2023, 4, 3), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 82, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567901", workSite = 38),
            Job(id = 120, date = LocalDate.of(2023, 6, 4), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 3, address = 83, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567902", workSite = 39),
            Job(id = 121, date = LocalDate.of(2023, 8, 5), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 85, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567903", workSite = 40),
            Job(id = 122, date = LocalDate.of(2023, 10, 6), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 86, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567904", workSite = 41),
            Job(id = 123, date = LocalDate.of(2023, 12, 7), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 87, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567905", workSite = 42),
            Job(id = 124, date = LocalDate.of(2024, 1, 1), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 88, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567906", workSite = 43),
            Job(id = 125, date = LocalDate.of(2024, 3, 31), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 89, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567907", workSite = 44),
            Job(id = 127, date = LocalDate.of(2024, 5, 3), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 90, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567908", workSite = 45),
            Job(id = 128, date = LocalDate.of(2024, 7, 29), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 92, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567909", workSite = 46),
            Job(id = 129, date = LocalDate.of(2024, 9, 5), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 93, endTime = LocalTime.of(9, 0, 0), electic = false, alarm = false, airConditioning = true, customer = "1234567910", workSite = 47),
            Job(id = 130, date = LocalDate.of(2024, 11, 27), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 94, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567911", workSite = 48),
            Job(id = 131, date = LocalDate.of(2025, 1, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 95, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567912", workSite = 49),
            Job(id = 132, date = LocalDate.of(2025, 2, 3), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 96, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567913", workSite = 50),
            Job(id = 133, date = LocalDate.of(2025, 3, 4), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 100, endTime = LocalTime.of(9, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "1234567914", workSite = 51),
            Job(id = 135, date = LocalDate.of(2026, 2, 18), startTime = LocalTime.of(14, 0, 0), description = "", peopleNumber = 2, address = 12, endTime = LocalTime.of(18, 0, 0), electic = false, alarm = false, airConditioning = true, customer = "GRCGRG72P05F205M", workSite = null),
            Job(id = 136, date = LocalDate.of(2026, 5, 15), startTime = LocalTime.of(8, 0, 0), description = "Rifacimento impianto elettrico", peopleNumber = 2, address = 107, endTime = LocalTime.of(18, 0, 0), electic = true, alarm = false, airConditioning = false, customer = "ESPGNN80A01F839U", workSite = 55)
        )
