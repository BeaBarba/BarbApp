...
object seedDatabase {
    ...
    suspend fun seedJob(repository: Repository){
        val jobs = listOf(
            ...
            Job(id = 9, date = LocalDate.of(2022, 1, 10), startTime = LocalTime.of(8, 0, 0), description = "Tracciatura impianti", peopleNumber = 2, address = 10, endTime = LocalTime.of(12, 0, 0), electric = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 1),
            Job(id = 10, date = LocalDate.of(2022, 1, 10), startTime = LocalTime.of(13, 0, 0), description = "Posa tubazioni", peopleNumber = 2, address = 10, endTime = LocalTime.of(17, 0, 0), electric = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 1),
            ...
            Job(id = 95, date = LocalDate.of(2022, 3, 2), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 2, address = 10, endTime = LocalTime.of(9, 0, 0), electric = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 2),
            Job(id = 96, date = LocalDate.of(2022, 3, 3), startTime = LocalTime.of(8, 0, 0), description = "Visto lavoro", peopleNumber = 4, address = 64, endTime = LocalTime.of(9, 0, 0), electric = true, alarm = false, airConditioning = false, customer = "RCCDVD78L15F205O", workSite = 3),
